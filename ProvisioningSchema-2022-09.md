...
RegistrationType|RegistrationType|The RegistrationType of the CustomAction, optional attribute.|No|
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
Title|xsd:string|Defines the title of the WebPart, required attribute.|Yes|
Row|xsd:int|Defines the row to add the WebPart to, required attribute.|Yes|
Column|xsd:int|Defines the column to add the WebPart to, required attribute.|Yes|
<a name="contents"></a>
### Contents
...
--------|----|-----------|--------|-------
Title|xsd:string|Defines the title of the WebPart, required attribute.|Yes|
Zone|xsd:string|Defines the zone of a WebPart Page to add the webpart to, required attribute.|Yes|
Order|xsd:int|Defines the index of the WebPart in the zone, required attribute.|Yes|
<a name="contents"></a>
### Contents
Defines the WebPart XML, required element.
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
Name|xsd:string|The Name of the ComposedLook, required attribute.|Yes|
ColorFile|xsd:string|The ColorFile of the ComposedLook, required attribute.|Yes|
FontFile|xsd:string|The FontFile of the ComposedLook, required attribute.|Yes|
BackgroundFile|xsd:string|The BackgroundFile of the ComposedLook, optional attribute.|Yes|
Version|xsd:int|The Version of the ComposedLook, optional attribute.|No|
<a name="workflows"></a>
### Workflows
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
PackageId|ReplaceableString|Defines the ID of the package to manage, optional attribute (either this one or the Src has to be provided)|No|
Src|xsd:string|Defines the path of the package to manage, optional attribute (either this one or the PackageId has to be provided).|No|
Action||Defines the action to execute against the package, required attribute|Yes|
SkipFeatureDeployment|xsd:boolean|Defines whether to skip the feature deployment for tenant-wide enabled packages, optional attribute (default: false).|No|false
Overwrite|xsd:boolean|Defines whether to overwrite an already existing package in the AppCatalog, optional attribute (default: false).|No|false
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
Enabled|xsd:boolean|Defines whether the CDN has to be enabled or disabled, required attribute.|Yes|
NoDefaultOrigins|xsd:boolean|Defines whether the CDN should have default origins, optional attribute.|No|false
<a name="origins"></a>
### Origins
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
AutoCheckRequirements||Defines how an engine should behave if the requirements for provisioning publishing capabilities are not satisfied by the target site, required attribute.|Yes|
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
DesignPackagePath|xsd:string|Defines the path of the Design Package to import into the current Publishing site, required attribute.|Yes|
MajorVersion|xsd:int|The Major Version of the Design Package to import into the current Publishing site, optional attribute.|No|
MinorVersion|xsd:int|The Minor Version of the Design Package to import into the current Publishing site, optional attribute.|No|
PackageGuid|GUID|The ID of the Design Package to import into the current Publishing site, optional attribute.|No|
PackageName|xsd:string|The Name of the Design Package to import into the current Publishing site, required attribute.|Yes|
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
Enabled|xsd:boolean|Defines whether the Extensibility Provider is enabled or not, optional attribute.|No|false
HandlerType|xsd:string|The type of the handler. It can be a FQN of a .NET type, the URL of a node.js file, or whatever else, required attribute.|Yes|
...
SiteDesign|ReplaceableString|The ID of the SiteDesign, if any, to apply to the target Site, optional attribute.|No|
AllowFileSharingForGuestUsers|xsd:boolean|Defines whether the target Site can be shared to guest users or not, optional attribute.|No|
Classification|ReplaceableString|The Classification of the target Site, if any, optional attribute.|No|
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
Alias|ReplaceableString|The Alias of the target Site, required attribute.|Yes|
DisplayName|ReplaceableString|The DisplayName of the target Site, required attribute.|Yes|
IsPublic|xsd:boolean|Defines whether the Office 365 Group for the target Site is Public or Private, required attribute.|Yes|
Classification|ReplaceableString|The Classification of the target Site, if any, optional attribute.|No|
Teamify|xsd:boolean|Defines whether to create a Microsoft Team backing the modern Team Site, optional attribute.|No|false
HideTeamify|xsd:boolean|Defines whether to hide the create a Microsoft Team option in the UI of the Team Site, optional attribute.|No|false
GroupLifecyclePolicyId|ReplaceableString|Allows to associate the Office 365 Group associated with the Team Site to a Group Lifecycle Policy, optional attribute.|No|
Language|ReplaceableString|Language of the target Site, optional attribute.|No|
SiteDesign|ReplaceableString|The ID of the SiteDesign, if any, to apply to the target Site, optional attribute.|No|
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
Description|xsd:string|The Description of the TermGroup to use for provisioning of TermSets and Terms, optional attribute.|No|
SiteCollectionTermGroup|xsd:boolean|Declares if the TermGroup is the Site Collection Term Group, optional attribute.|No|
UpdateBehavior||If the TermGroup already exists on target, this attribute defines whether the TermGroup will be overwritten or skipped.|No|Skip
Name|xsd:string|The Name of the Taxonomy Item, required attribute.|Yes|
ID|GUID|The ID of the Taxonomy Item, optional attribute.|No|
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
Owner|ReplaceableString|The Owner of the Term Set Item, optional attribute.|No|
Description|xsd:string|The Description of the Term Set Item, optional attribute.|No|
IsAvailableForTagging|xsd:boolean|Declares whether the Term Set Item is available for tagging, optional attribute.|No|true
<a name="termset"></a>
### TermSet
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
Language|xsd:int|The reference Language for the Term Set, optional attribute.|No|
IsOpenForTermCreation|xsd:boolean|Declares whether the Term Set is open for terms creation or not, optional attribute.|No|false
<a name="term"></a>
### Term
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
Language|xsd:int|The reference Language for the Term, optional attribute.|No|
CustomSortOrder|xsd:int|The Custom Sort Order for the Term, optional attribute.|No|0
IsReused|xsd:boolean|Declares if this term is reused, optional attribute.|No|false
IsSourceTerm|xsd:boolean|If the IsReused property is set to false, the current Term is not reused and this property will always be true. If the current Term is reused (IsReused returns true), then this property should be set to true if it is the source Term.|No|true
IsDeprecated|xsd:boolean|Declares if this term is deprecated, optional attribute.|No|false
SourceTermId|GUID|The ID of the source term if this term is reused, optional attribute.|No|
ReuseChildren|xsd:boolean|Declares if children of the source term should be reused, optional attribute.|No|false
IsPinned|xsd:boolean|Declares if this term is pinned, optional attribute. Requires IsReused set to true.|No|false
IsPinnedRoot|xsd:boolean|Declares if this term is the root of the pinned hierarchy, optional attribute. Requires IsPinned and IsReused set to true.|No|false
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
Language|xsd:int|The reference Language for the Term Label, required attribute.|Yes|
Value|xsd:string|The Value for the Term Label, required attribute.|Yes|
IsDefaultForLanguage|xsd:boolean|Declares whether the current Label is the default for the specific Language, optional attribute.|No|false
<a name="termsets"></a>
### TermSets
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
DisplayName|ReplaceableString|The Display Name of the Team, required attribute.|Yes|
Description|ReplaceableString|The Description of the Team, required attribute.|Yes|
Classification|ReplaceableString|The Classification for the Team, optional attribute.|No|
Visibility||The Visibility for the Team, optional attribute.|Yes|
Photo|ReplaceableString|Declares the Photo for the Team, optional attribute.|No|
HiddenGroupMembershipEnabled|xsd:boolean|Specifies whether to hide the members of the Microsoft 365 Group from users who aren't members of the group, optional attribute.|No|false
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
GroupId|ReplaceableString|Declares the ID of the targt Group/Team to update, optional attribute. Cannot be used together with CloneFrom or with ProvisioningTemplateId.|No|
TargetSiteUrl|ReplaceableString|Declares the URL of the targt Site to teamify, optional attribute. Cannot be used together with CloneFrom or with ProvisioningTemplateId.|No|
ProvisioningTemplateId|ReplaceableString|Declares the ID of a Provisioning Template to apply to the SharePoint Online site backing the current Team, optional attribute. Cannot be used together with CloneFrom or with TargetSiteUrl.|No|
Specialization||The Specialization for the Team, optional attribute.|No|
CloneFrom|ReplaceableString|Declares the ID of another Team to Clone the current Team from, optional attribute. Cannot be used together with GroupId, or with TargetSiteUrl.|No|
Archived|xsd:boolean|Declares whether the Team is archived or not, optional attribute.|No|false
MailNickname|ReplaceableString|Declares the nickname for the Team, optional attribute. Required for new Teams.|No|
...
MembershipType||Declares whether the Channel is Public, Private, or Shared, optional attribute (default public).|No|Standard
...
UserNewMessageRestriction||Declares the Channel reply restrictions, optional attribute (default everyone).|No|Everyone
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
Type||Defines the Type of Resource for the Tab, required attribute.|Yes|
TargetTabId|ReplaceableString|Defines the ID of the target Tab for the Resource, required attribute.|Yes|
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
AppId|xsd:string|Unique ID - from PnP perspective - for the App, defined for further reference in the Provisioning Template, required attribute.|Yes|
PackageUrl|ReplaceableString|The URL or path for the Teams App package, required attribute.|Yes|
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
AccountEnabled|xsd:boolean|Declares whether the user's account is enabled or not, required attribute.|Yes|
DisplayName|ReplaceableString|The Display Name of the user, required attribute.|Yes|
MailNickname|ReplaceableString|The Mail Nickname of the user, required attribute.|Yes|
PasswordPolicies|ReplaceableString|The Password Policies for the user, optional attribute.|No|
UserPrincipalName|ReplaceableString|The UPN for the user, required attribute.|Yes|
ProfilePhoto|ReplaceableString|The URL of the Photo for the user, optional attribute.|No|
GivenName|ReplaceableString|Declares the GivenName of the user, optional attribute.|No|
Surname|ReplaceableString|Declares the Surname of the user, optional attribute.|No|
JobTitle|ReplaceableString|Declares the Job Title of the user, optional attribute.|No|
OfficeLocation|ReplaceableString|Declares the Office Location of the user, optional attribute.|No|
PreferredLanguage|ReplaceableString|Declares the Preferred Language of the user, optional attribute.|No|
MobilePhone|ReplaceableString|Declares the Mobile Phone of the user, optional attribute.|No|
UsageLocation|ReplaceableString|Declares the Usage Location for licenses assigned to the user, required attribute.|Yes|
<a name="drive"></a>
### Drive
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
DriveUrl|ReplaceableString|Defines the relative URL of the target Drive item in OneDrive for Business. The target Drive must exist and will not be created by the Provisioning Engine.|Yes|
<a name="driveitems"></a>
### DriveItems
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
Name|ReplaceableString|Defines the Name of the Folder in OneDrive for Business.|Yes|
Src|ReplaceableString|Defines the Source path of the folder in OneDrive for Business. If provided, the whole folder will be uploaded.|No|
Overwrite|xsd:boolean|The Overwrite flag for the File items in the Directory, optional attribute.|No|false
Recursive|xsd:boolean|Defines whether to recursively browse through all the child folders of the source Folder, optional attribute.|No|false
IncludedExtensions|xsd:string|The file Extensions (lower case) to include while uploading the source Folder, optional attribute.|No|*.*
ExcludedExtensions|xsd:string|The file Extensions (lower case) to exclude while uploading the source Folder, optional attribute.|No|
<a name="drivefile"></a>
### DriveFile
...
Attibute|Type|Description|Required|Default
--------|----|-----------|--------|-------
Name|ReplaceableString|Defines the Name of the DriveItem in OneDrive for Business.|Yes|
Src|ReplaceableString|Defines the Source path of the file in OneDrive for Business.|Yes|
Overwrite|xsd:boolean|The Overwrite flag for the File items in the Directory, optional attribute.|No|false
